...
<!--                <div id="divshowhide" style="display:none;">
                    <?php  //echo do_shortcode('[contact-form-7 id="6340" title="Women"]') ;?>                   
                </div>  
-->
...
<?php // show hide: ?>
 ...
 <?php // event listener after the form has submitted: ?>                  
                <script>
...
<?php // using sendgrid, but did not verify the DNS, but it says it's working: https://wpmailsmtp.com/docs/how-to-set-up-the-sendgrid-mailer-in-wp-mail-smtp/ 
 ...
 //try next:  https://stackoverflow.com/questions/39953217/contact-form-7-dynamic-recipient-email
    
    
    
    ?>
                <script>
                    function sendwomanmail() {
                        //alert("send mail?");
                        //wp_mail( 'toebird1966@gmail.com', 'WP Mail Test', 'Mail is working' );
                    }
                </script>
